...
export default function Footer() {
  ...
  return (
    <footer className="light:to-[#fae8ff] light:bg-gradient-to-t light:from-purple/50 to-transparent dark:bg-purple/10  font-lato px-2  lg:m-auto lg:px-8 dark:text-white/70 text-[#4f3670] ">
      <div className="grid grid-cols-2 lg:grid-cols-12 py-2 w-full ">
