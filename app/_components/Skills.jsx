      ...
      <div className="w-3/4 sm:w-10/12">
        ...
        <div className="flex flex-col items-center mt-2 ">
          <div className="flex flex-col md:flex-row  md:flex-wrap justify-center  lg:flex-nowrap lg:flex-row gap-6 lg:gap-20 xl:justify-around  ">
            <div className="font-lato  shadow-purple/40 shadow-md  sm:w-64 px-2 sm:px-6 py-2 sm:py-4 gap-1 sm:gap-8 flex flex-col ">
            ...
            <div className="font-lato shadow-purple/40 shadow-md sm:w-64 px-2 sm:px-6 sm:py-4 py-2 gap-1 sm:gap-8 flex flex-col ">
              <div className="flex flex-col items-center gap-4">
            ...
            <div className="font-lato shadow-purple/40 shadow-md sm:w-64  sm:px-6 sm:py-4 py-2 gap-1 sm:gap-8 flex flex-col ">
              <div className="flex flex-col items-center gap-4">
