    ...
    <div className="tracking-wide ">
      <div>
        ...
        <p className=" font-poppins pt-2 md:pt-8 mb-12 md:mb-24 text-[1rem] md:text-[1.1rem]">
          ...
          d'amélioration, j'aime explorer de nouvelles technologies et bonnes
          pratiques pour optimiser mes projets. <br /> Je continue de développer
          mes compétences en travaillant sur des projets variés, incluant des
          collaborations en freelance.
        </p>
      </div>
      ...
      <div className=" mt-10 md:mt-20   ">
        <div className="flex flex-col justify-center items-center  md:items-stretch   md:flex-row  md:flex-wrap   gap-6 md:gap-10  ">
          <div className="font-poppins   border-2 border-purple/50  shadow-sm rounded-xl w-[22rem] md:w-[30rem] 2xl:w-[18rem] px-2 sm:px-6 py-2 sm:py-4 gap-1 sm:gap-4 flex flex-col  ">
          ...
          <div className="font-poppins border-2 border-purple/50  shadow-sm rounded-xl w-[22rem] md:w-[30rem] 2xl:w-[18rem]  px-2 sm:px-6 sm:py-4 py-2 gap-1 sm:gap-4 flex flex-col ">
            <div className="flex flex-col items-center  gap-6">
              <div className="flex flex-col">
          ...
          <div className="font-poppins border-2 border-purple/50  shadow-sm rounded-xl w-[22rem] md:w-[30rem] 2xl:w-[18rem] sm:px-6 sm:py-4 py-2 gap-1 sm:gap-4 flex flex-col ">
            <div className="flex flex-col items-center gap-6">
              <div className="flex flex-col">
