        ...
        <div className="py-8 gap-6 mx-auto">
          ...
          <div className="  text-[1rem] leading-7">
            ...
            <ul className="  mt-4 gap-2 flex flex-col">
              ...
              <li className="flex gap-1 items-center md:ml-4 ">
                {" "}
                <Check size={20} color="#8300e9" /> Optimisation SEO pour un
              ...
              <li className="flex gap-1 items-center md:ml-4 ">
                ...
                performances (chargement rapide, animations fluides, lazy
                loading...)
              </li>
              <li className="flex gap-1 items-center md:ml-4 ">
                <Check size={20} color="#8300e9" />
        ...
        <div className=" py-8 gap-6 mx-auto ">
          ...
          <div className="   text-[1rem] leading-7">
            ...
            <ul className="mt-4 gap-2 flex flex-col">
              ...
              <li className="flex gap-1 items-center md:ml-4 ">
                <Check size={20} color="#8300e9" /> Gestion et structuration des
                bases de données
              </li>
              <li className="flex gap-1 items-center md:ml-4 ">
                <Check size={20} color="#8300e9" /> Création et gestion d'API
                pour la communication frontend-backend
              </li>
              <li className="flex gap-1 items-center md:ml-4 ">
                <Check size={20} color="#8300e9" />
