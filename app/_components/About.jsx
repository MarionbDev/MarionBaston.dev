...
import myPhoto from "../../public/images/photoPortfolio.png";

export default function About() {
  return (
    <div className="text flex flex-col items-center justify-center pt-6 pb-28  bg-pale_pink ">
      <div className="w-3/4 ">
          ...
          <div className=" col-start-1 col-span-11 row-start-2 row-span-6 ">
            ...
            <div className="text-base md:text-md p-8 border bg-white/50 backdrop-blur-lg drop-shadow-sm rounded-2xl relative ">
              ...
              <p className="mt-5">
                ...
                l'accessibilité et l'optimisation pour les moteurs de recherche
                (SEO). Je suis déterminée à concevoir des expériences web
                inclusives et à créer des sites internet qui offrent une
                excellente expérience utilisateur pour tous, tout en veillant à
                ce qu'ils soient bien positionnés sur les moteurs de recherche
                pour atteindre un public plus large. J'apprécie le travail en
